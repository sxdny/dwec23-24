...
class Planeta {
  ...
  constructor(nombre, volumen, vecesTamanyoSol, distanciaSol, fechaDescubrimiento) {
    this.nombre = "Planeta";
...
planetas.forEach(e => {
  ...
  // iterando las propiedades de los objetos
...
console.log("Planetas ordenador por 'distancia al Sol' (menor a mayor): ");
